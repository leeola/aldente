...
type data struct {
	Groups map[string]archData
}

type archData map[string]machineReplicates
type machineReplicates map[int]ald.MachineRecord
...
// func (db *MarshalDb) UpdateMachine(m ald.MachineRecord) (bool, error) {
// 	if m.Name == "" {
// 		return errors.New("missing required field: Name")
// 	}
// 	if m.Group == "" {
...
func (db *MarshalDb) UpsertMachine(m ald.MachineRecord) (bool, error) {
	// if m.Name == "" {
	// 	return errors.New("missing required field: Name")
	// }
	// if m.Group == "" {
	// 	return errors.New("missing required field: Group")
	// }
	// if m.Provider == "" && m.Connection == "" {
	// 	return errors.New("missing required field: Provider or Connection")
	// }
	...
	// reps, ok := d.Groups[m.Group]
	// if !ok {
	// 	reps = map[int]ald.MachineRecord{}
	// }

	// // if _, exists := reps[m.Index]; exists {
	// // 	return false, nil
	// // }
